...
import GeometryRashContent from "@/components/content/GeometryRashContent";
  ...
  content: {
    ...
    gameSection: {
      ...
      game: {
        ...
        title: "Geometry Rash",
        externalUrl: "/geometry-rash/index.html",
      },
    },
    otherGames: {
      title: "Other Games",
...
export default function GeometryRashPage() {
  return (
